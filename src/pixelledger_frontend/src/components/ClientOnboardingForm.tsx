...
import { ClientInfo, Profile } from '../../../declarations/pixelledger_backend/pixelledger_backend.did';
...
const projectTypeOptions = [
  ...
  'Digital Marketing', 'Content Creation', 'Social Media Campaign'
];

const goalOptions = [
  'Build Brand Identity', 'Increase Online Presence', 'Launch Product',
  'Website Redesign', 'Marketing Campaign', 'Content Strategy'
];
...
const ClientOnboardingForm: React.FC<ClientOnboardingFormProps> = ({ onRegistrationComplete }) => {
  ...
  const onSubmit: SubmitHandler<FormData> = async (data) => {
    try {
      ...
      const clientValidationErrors = validateClientInfo([clientInfo]);
      if (clientValidationErrors.length > 0) {
        toast.error("Validation Error", {
          description: clientValidationErrors.join(', ')
        });
        return;
      }
      ...
      const result = await registerUser({ 'Client': null }, clientInfo, undefined, profile);
        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <h1 className="text-3xl font-bold mb-2">
              Client <span className="bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">Onboarding</span>
            </h1>
                    ...
                    {step === 2 && (
                      <div className="space-y-4">
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-white">Monthly Project Budget (ICP)</FormLabel>
                              <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <FormControl>
                                  <SelectTrigger className="bg-gray-800 border-gray-600 text-white">
                        ...
                        <FormField
                          ...
                          render={() => (
                            <FormItem>
                              <FormLabel className="text-white">Preferred Project Types</FormLabel>
                        ...
                        <FormField
                          ...
                          render={() => (
                            <FormItem>
                              <FormLabel className="text-white">Creative Goals</FormLabel>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="p-4 bg-gray-800/50 rounded-lg border border-blue-500/20">
                          ...
                          <div className="space-y-2 text-sm">
                            ...
                            <p><span className="text-blue-400">Project Types:</span> <span className="text-gray-300">{form.watch('projectTypes').join(', ')}</span></p>
                          </div>
                        </div>
