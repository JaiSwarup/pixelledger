      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-6">
        <div className="max-w-4xl w-full">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Select your role to get started with BrandPool</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-2xl mx-auto">
            ...
            <Card className="bg-gray-900/50 backdrop-blur-sm border-gray-700 hover:border-blue-500/50 transition-all duration-300 cursor-pointer group">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl text-white">I'm a Brand</CardTitle>
                <CardDescription className="text-gray-400">
                  Connect with talented influencers to promote your products and services
                </CardDescription>
              </CardHeader>
              <CardContent className="text-center">
                <ul className="text-sm text-gray-300 space-y-2 mb-6">
                  <li>• Create and manage campaigns</li>
                  <li>• Find the perfect influencers</li>
            ...
            <Card className="bg-gray-900/50 backdrop-blur-sm border-gray-700 hover:border-purple-500/50 transition-all duration-300 cursor-pointer group">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl text-white">I'm an Influencer</CardTitle>
                <CardDescription className="text-gray-400">
                  Monetize your content and connect with brands that align with your values
                </CardDescription>
              </CardHeader>
              <CardContent className="text-center">
                <ul className="text-sm text-gray-300 space-y-2 mb-6">
                  <li>• Apply to exciting campaigns</li>
                  <li>• Showcase your portfolio</li>
                  <li>• Get paid securely</li>
                  <li>• Build brand partnerships</li>
                </ul>
                <Button 
